...
fig1, _ = plotMassEnvelopes(data_mean["Time"], data_mean["Total"], data_mean[radii_names], radii, radii_names, 
                       "Myr", "M☉", "kpc", title="$f_{gas} = 0.7$ real04", relative=False)
fig2, _ = plotMassEnvelopes(data_mean["Time"], data_mean["Total"], data_mean[radii_names],radii, radii_names, 
                       "Myr", "M☉", "kpc", title="$f_{gas} = 0.7$ real04", relative=True)
...
fig1.savefig("org_fgas=0.7_real04_mean_absolute_Mstar_envelope.pdf")
fig2.savefig("org_fgas=0.7_real04_mean_relative_Mstar_envelope.pdf")
fig3.savefig("org_fgas=0.7_real04_x_absolute_Mstar_envelope.pdf")
fig4.savefig("org_fgas=0.7_real04_x_relative_Mstar_envelope.pdf")
